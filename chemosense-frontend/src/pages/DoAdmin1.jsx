                ...
                <div className="flex-1 relative">
                    ...
                    <div className="flex items-center gap-8">
                        ...
                        <div className="relative w-[200px]">
                            ...
                            >
                                <option value="doctor" className="text-black bg-white hover:bg-blue-500 transition-all duration-200 cursor-pointer font-semibold">Doctor Registration</option>
                                <option value="patient" className="text-black bg-white hover:bg-blue-500 transition-all duration-200 cursor-pointer font-semibold">Patient Registration</option>
                            </select>
