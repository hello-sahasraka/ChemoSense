...
import { Link, router } from 'expo-router'; // Added router for potential programmatic navigation
...
const Logo = () => (
  <StyledImage
    source={require('../assets/images/HeartLogo 1.png')} // Adjusted path
...
const PatLogIn = () => { // Renamed component
...
export default PatLogIn; // Renamed export
