...
import { db } from '../../firebaseConfig'; // adjust path accordingly if firebaseConfig is in project root
*/
            ...
            <ScrollView contentContainerStyle={{ alignItems: 'center', paddingVertical: 20 }}>
                ...
                <View className="w-11/12 bg-white rounded-lg p-5 shadow-md">
                    ...
                    <TextInput
                        className="bg-gray-200 p-3 rounded-md mb-4"
                        value={profile.email}
                        editable={false} // This was true in the original, but the comment implies it should be blank and likely editable by user later
