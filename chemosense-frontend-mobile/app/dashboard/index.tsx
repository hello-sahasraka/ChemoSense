...
import { View, Text, Image, Dimensions, TouchableOpacity, GestureResponderEvent } from 'react-native';
...
const PatDashboard = () => {
  ...
  {/* Greeting section */}
  <View>
    <Text className="text-xl font-semibold text-gray-800">Hi, Christina</Text>
    ...
    <View className="absolute bottom-0 right-0 bg-white rounded-full p-0.5">
      ...
      <View className="bg-white rounded-2xl p-4 mb-3 shadow-md h-40">
        <View className="flex-row justify-between items-center mb-2">
          <Text className="text-base font-semibold text-gray-700">Heart rate</Text>
      ...
      <View className="flex-row flex-wrap justify-between">
        ...
        <View className="w-[48%] bg-white rounded-2xl p-3 mb-3 shadow-md justify-center items-center h-36">
          ...
          <Text className="text-3xl font-bold text-orange-500">{temperature}°C</Text>
        </View>
